export declare const NATIVE_TOKEN = "native_token";
...
export type Action = MintERC20Action | BurnERC20Action | TransferAction | SwapAction | ENSRegisterAction | WrapNativeTokenAction | UnwrapNativeTokenAction | SupplyAction | MintNFTAction;
